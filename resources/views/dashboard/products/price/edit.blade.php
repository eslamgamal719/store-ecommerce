                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/product.edit product price')}}    </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.products.price.update')}}"
                                              method="POST"
                                    ...
                                    <input type="hidden" name="product_id" value="{{$product->id}}">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>    {{__('admin/product.edit product price')}}  </h4>
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="special_price_type" class=" form-control" >
                                                                <optgroup label="من فضلك اختر النوع">
                                                                    <option {{($product->special_price_type) == 'percent' ? 'selected' : ''}}
                                                                            value="percent">percent</option>

                                                                    <option {{($product->special_price_type) == 'fixed' ? 'selected' : ''}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <input type="date"
                                                                   ...
                                                                   class="form-control"
                                                                   value="@php echo strftime('%Y-%m-%d', strtotime($product['special_price_start'])) @endphp"/>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <input type="date"
                                                                   ...
                                                                   class="form-control"
                                                                   value="@php echo strftime('%Y-%m-%d', strtotime($product['special_price_end'])) @endphp"/>
