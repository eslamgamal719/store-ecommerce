                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.products.stock.update')}}"
                                              method="POST"
                                    ...
                                    <input type="hidden" name="product_id" value="{{$product->id}}">
                                            ...
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="form-control"
                                                                ...
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option {{($product->manage_stock) == 1 ? 'selected' : ''}} value="1">{{__('admin/product.track')}}</option>
                                                                    <option {{($product->manage_stock) == 0 ? 'selected' : ''}} value="0">{{__('admin/product.not track')}} </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="in_stock" class="form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    <option {{($product->in_stock) == 1 ? 'selected' : ''}}  value="1">{{__('admin/product.available')}}</option>
                                                                    <option {{($product->in_stock) == 0 ? 'selected' : ''}}  value="0">{{__('admin/product.unavailable')}} </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                    ...
                                                    <div class="col-md-6" style="display:{{$product->manage_stock == 1 ? 'block' : 'none'}}"  id="qtyDiv">
                                                        <div class="form-group">
