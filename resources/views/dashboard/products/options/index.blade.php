        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/product.options')}}</h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/product.all options')}}</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/product.product')}}</th>
                                                <th>{{__('admin/product.attribute')}}</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <form action="{{route('admin.options.destroy',$option -> id)}}" method="post" style="display: inline-block">
                                                                    @csrf
                                                                    {{method_field('delete') }}
