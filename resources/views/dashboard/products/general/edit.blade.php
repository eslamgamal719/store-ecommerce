                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-form"> {{__('admin/product.edit product')}} </h4>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="{{$locale}}[description]" id="description"
                                                                  cols="20"
                                                                  rows="10"
                                                                  class="ckeditor" placeholder="">{{$product->translate($locale)->description}}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="{{$locale}}[short_description]"
                                                                  ...
                                                                  class="form-control"
                                                                  placeholder=""
                                                        >{{$product->translate($locale)->short_description}}</textarea>
