                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.dashboard')}}">{{__('admin/brands.main')}} </a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.brands.index')}}"> {{__('admin/brands.brands')}} </a>
                                </li>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        ...
                                                        class="rounded-circle  height-150 image-preview img-thumbnail" alt="صورة القسم  ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <img src="{{asset('assets/images/brands/default.jpeg')}}" style="width: 80px" class="img-thumbnail image-preview">
                                            </div>
